...
use App\Http\Controllers\MediaControllerfront;
...
Route::group(["prefix" => "admin", 'middleware' => ['auth:sanctum']], function () {
  ...
  Route::post('/register', [AuthController::class, 'register']);
  // page content
  Route::post('/page/add', [PageController::class, 'store']);
  ...
  Route::get('/list_abn', [AbonneController::class, 'liste_abn']);
  Route::get('/list_abn_imp', [AbonneController::class, 'liste_abn_imp']);
  Route::get('/abonnes_ord', [AbonneController::class, 'indexs']);
...
route::get('/recue_paiement', function () {
  return view('recue_paiement');
});
Route::get('/t', function () {
  return view('welcome');
});
Route::get('/', function () {
  return view('awelcome');
});
Route::post('/imp_abn', [AbonneController::class, 'abonne_by_gare']);
Route::get('/imprim_abn', [AbonneController::class, 'imprim_abn']);
Route::get('/send_sms', [AbonneController::class, 'send_sms']);
Route::get('/admin/verifpay', [AbonneController::class, 'verifpay']);
Route::get('/admin/clonepay', [AbonneController::class, 'clone_pay']);
Route::get('/admin/envoie', [AbonneController::class, 'envoie']);
